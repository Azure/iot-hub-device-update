...
Usage: build.sh [options...]
    ...
    -u, --ubuntu-core-snap-only           Only build components and features those required for the Ubuntu Core snap.

    --work-folder <work_folder>           Specifies the folder where source code will be cloned or downloaded.
                                              Default is /tmp.
...
# When building the snap, we don't want to build the .deb packages.
