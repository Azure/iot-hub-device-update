...
[00]() | [01](#swupdate-content-handler-result-codes-0x301) | [02]() | [03]() | [04]() | [05]() | [06]() | [07]() | [20]()
...
typedef enum tagADUC_Content_Handler
{
    ...
    /*indicates errors from Bundle Update Handler. */
    ADUC_CONTENT_HANDLER_BUNDLE = 0x04,

    /*indicates errors from Components Update Handler. */
    ADUC_CONTENT_HANDLER_COMPONENTS = 0x05,

    /*indicates errors from Script Update Handler. */
    ADUC_CONTENT_HANDLER_SCRIPT = 0x06,

    /*indicates errors from Basic File Update Handler. */
    ADUC_CONTENT_HANDLER_BASIC_FILE = 0x07,
...
#### Bundle Update Content Handler Result Codes (0x304#####)

##### Macro for creating extended result codes

```c
static inline ADUC_Result_t MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(const int32_t value)
{
    return MAKE_ADUC_CONTENT_HANDLER_EXTENDEDRESULTCODE(ADUC_CONTENT_HANDLER_BUNDLE, value);
}
```
...
| Extended Result Code | C Macro | Note |
|:----|:----|:----|
| 0x30400001 |ADUC_ERC_BUNDLE_HANDLER_CREATE_LEAF_WORKFLOW_BAD_MANIFEST  |
| 0x30400002 |ADUC_ERC_BUNDLE_HANDLER_CREATE_LEAF_WORKFLOW_BAD_BASE_MANIFEST  |
| 0x30400003 |ADUC_ERC_BUNDLE_HANDLER_CREATE_LEAF_WORKFLOW_BAD_FILEURLS  |
| 0x30400004 |ADUC_ERC_BUNDLE_HANDLER_CREATE_LEAF_WORKFLOW_CANT_ADD_TO_PARENT  |
| 0x30400005 |ADUC_ERC_BUNDLE_HANDLER_INSTALLCRITERIA_PERSIST_FAILURE  |
| 0x30400014 |ADUC_ERC_BUNDLE_CONTENT_HANDLER_CREATE_FAILURE_FILEURLS_CLONE_FAILURE  |
| 0x30400015 |ADUC_ERC_BUNDLE_CONTENT_HANDLER_COMPONENT_ENUMERATION_FAILURE  |
| 0x30400016 |ADUC_ERC_BUNDLE_CONTENT_HANDLER_COMPONENT_ENUMERATION_FAILURE  |
| 0x30400017 |ADUC_ERC_BUNDLE_CONTENT_HANDLER_SET_SELECTED_COMPONENTS_FAILURE  |
| 0x30400018 |ADUC_ERC_BUNDLE_CONTENT_HANDLER_GET_FILE_ENTITY_FAILURE  |
| 0x30400019 |ADUC_ERC_BUNDLE_CONTENT_HANDLER_GET_LEAF_COMPAT_FAILURE  |
...
| Extended Result Code | C Macro | Note |
|:----|:----|:----|
| 0x30400100 | ADUC_ERC_BUNDLE_CONTENT_HANDLER_DOWNLOAD_FAILURE_UNKNOWNEXCEPTION |

###### Install Related Extended Result Codes

| Extended Result Code | C Macro | Note |
|:----|:----|:----|
| 0x30400200 |ADUC_ERC_BUNDLE_CONTENT_HANDLER_INSTALL_FAILURE_UNKNOWNEXCEPTION|
| 0x30400201 |ADUC_ERC_BUNDLE_CONTENT_HANDLER_INSTALL_FAILURE_MISSING_CHILD_WORKFLOW|
...
| Extended Result Code | C Macro | Note |
|:----|:----|:----|
| 0x30400400 |ADUC_ERC_APT_HANDLER_PACKAGE_CANCEL_FAILURE|
...
#### Components Update Content Handler Result Codes (0x305#####)

##### Macro for creating extended result codes

```c
static inline ADUC_Result_t MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(const int32_t value)
{
    return MAKE_ADUC_CONTENT_HANDLER_EXTENDEDRESULTCODE(ADUC_CONTENT_HANDLER_COMPONENTS, value);
}
```
...
| Extended Result Code | C Macro | Note |
|:----|:----|:----|
| 0x30500001 |ADUC_ERC_COMPONENTS_HANDLER_INITIALIZATION_FAILURE  |
| 0x30500002 |ADUC_ERC_COMPONENTS_HANDLER_INVALID_COMPONENTS_DATA  |
| 0x30500003 |ADUC_ERC_COMPONENTS_HANDLER_GET_FILE_ENTITY_FAILURE  |
| 0x30500004 |ADUC_ERC_COMPONENTS_HANDLER_CREATE_SANDBOX_FAILURE  |
| 0x30500005 |ADUC_ERC_COMPONENTS_HANDLER_SET_SELECTED_COMPONENTS_FAILURE  |

###### Download Related Extended Result Codes

| Extended Result Code | C Macro | Note |
|:----|:----|:----|
| 0x30500100 | ADUC_ERC_COMPONENTS_HANDLER_DOWNLOAD_FAILURE |
| 0x30500101 | ADUC_ERC_COMPONENTS_HANDLER_DOWNLOAD_FAILURE_UNKNOWN_EXCEPTION |

###### Install Related Extended Result Codes

| Extended Result Code | C Macro | Note |
|:----|:----|:----|
| 0x30500201 |ADUC_ERC_COMPONENTS_HANDLER_INSTALL_FAILURE_NO_INSTRUCTION_FILE|
| 0x30500202 |ADUC_ERC_COMPONENTS_HANDLER_INSTALL_FAILURE_INSTRUCTION_PARSE_FAILURE|
| 0x30500203 |ADUC_ERC_COMPONENTS_HANDLER_INSTALL_FAILURE_INSTALLITEM_BAD_DATA|
| 0x30500204 |ADUC_ERC_COMPONENTS_HANDLER_INSTALL_FAILURE_NO_UPDATE_TYPE|
| 0x30500210 |ADUC_ERC_COMPONENTS_HANDLER_INSTALL_INSTALLITEM_INSTALL_UNKNOWN_EXCEPTION|
| 0x30500211 |ADUC_ERC_COMPONENTS_HANDLER_INSTALL_INSTALLITEM_ISINSTALLED_UNKNOWN_EXCEPTION|

###### Apply Related Result Codes

| Extended Result Code | C Macro | Note |
|:----|:----|:----|
| 0x30500310 |ADUC_ERC_COMPONENTS_HANDLER_APPLY_INSTALLITEM_INSTALL_UNKNOWN_EXCEPTION|
| 0x30500311 |ADUC_ERC_COMPONENTS_HANDLER_APPLY_INSTALLITEM_ISINSTALLED_UNKNOWN_EXCEPTION|
...
| 0x80400006 |ADUC_ERC_UTILITIES_WORKFLOW_UTIL_COPY_UPDATE_ACITON_FROM_BASE_FAILURE  |
