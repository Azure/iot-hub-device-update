...
class AptDeploymentTest(unittest.TestCase):
    ...
    def test_AptDeployment(self):
        ...
        self.deploymentUpdateId = UpdateId(provider="Fabrikaam",name="Vacuum",version="1.0.1")
        ...
        for i in range(0,15):
            ...
            #
            # If we see all the devices completing the
            if (deploymentStatus.totalDevices == deploymentStatus.devicesCompletedSucceededCount):
