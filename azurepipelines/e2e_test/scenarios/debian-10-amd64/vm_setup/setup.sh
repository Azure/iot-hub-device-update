...
# license information.
# --------------------------------------------------------------------------
# Setup Script for Test: debian-10-amd64-APT-deployment
#
...
#
# Install Device Update Dependencies from Release Repo
#
...
wget https://github.com/microsoft/do-client/releases/download/v0.9.0/debian10_x64-packages.tar -O debian10_x64-packages.tar
