...
<#
    ...
    .EXAMPLE
        ...
        PS >
        PS > New-ComplexImportUpdateRequest.ps1 -AccountEndpoint sampleaccount.api.adu.microsoft.com -InstanceId sampleinstance `
...
# -----------------------------------------------------------
# Create ADU Import Update request body
# -----------------------------------------------------------
Write-Host 'Creating import update API request ...'

$importUpdateInput = $parentUpdate, $microphoneUpdate, $speakerUpdate
return $importUpdateInput | ConvertTo-Json -Depth 50
