...
typedef enum ADUC_AGENT_INFO_WORKFLOW_STATE_TAG
{
    ADUC_AGENT_INFO_WORKFLOW_STATE_UNKNOWN = 0,
    ADUC_AGENT_INFO_WORKFLOW_STATE_INITIALIZING = 1,
    ADUC_AGENT_INFO_WORKFLOW_STATE_INITIALIZED = 2,
    ADUC_AGENT_INFO_WORKFLOW_STATE_SUBSCRIBING = 2,
    ADUC_AGENT_INFO_WORKFLOW_STATE_SUBSCRIBED = 3,
    ADUC_AGENT_INFO_WORKFLOW_STATE_PUBLISHING = 4,
    ADUC_AGENT_INFO_WORKFLOW_STATE_PUBLISHED = 5,
    ADUC_AGENT_INFO_WORKFLOW_STATE_PROCESSING_RESPONSE = 6,
    ADUC_AGENT_INFO_WORKFLOW_STATE_INFO_REPORT_COMPLETED = 7,
} ADUC_AGENT_INFO_WORKFLOW_STATE;

typedef struct ADUC_AgentToServiceMessage_TAG
{
    char* correlationId;
    char* messageType;
    char* contentType;
...
typedef struct ADUC_AGENT_INFO_MANAGEMENT_STATE_TAG
{
