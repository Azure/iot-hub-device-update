 ...
 * @param maxTimeoutInSeconds The maximum number of seconds before the download will timeout.
...
{
    return do_download(entity, workflowId, workFolder, maxTimeoutInSeconds, downloadProgressCallback);
}
