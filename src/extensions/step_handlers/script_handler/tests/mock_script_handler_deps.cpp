/**
 * @file mock_script_handler_deps.cpp
 * @brief Mock implementations of all external dependencies used by script_handler.cpp.
 */
...
const char* mock_json_result_file_content = nullptr;
...
void mock_script_handler_reset(void)
{
    ...
    mock_json_result_file_content = nullptr;
}
