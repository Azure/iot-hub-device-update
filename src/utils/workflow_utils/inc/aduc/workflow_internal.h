...
typedef struct tagADUC_Workflow
{
    ...
    struct tagADUC_Workflow* DeferredReplacementWorkflow; /**< A replacement workflow that came in while another deployment was in progress. */
} ADUC_Workflow;
