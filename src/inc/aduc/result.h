...
/**
 * @brief ADUC_ERC_MOVE_HASH_VERIFICATION_FAILED, ERC Value: 2425356296 (0x90900008)
 */
#define ADUC_ERC_MOVE_HASH_VERIFICATION_FAILED \
    MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_SOURCE_UPDATE_CACHE(8)
...
//
// SWUpdate Handler v2 Extended Result Codes
#include "swupdate_handler_result_codes.h"
