...
typedef enum tagADUC_Facility
{
    ...
    ADUC_FACILITY_DATASTORE=11, //!< ADUC_FACILITY_DATASTORE : 11, ADUC Datastore facility
...
typedef enum tagADUC_FACILITY_DATASTORE_Components
{
    ADUC_COMPONENT_DATASTORE_VIEWSTATE=0, //!< ADUC_COMPONENT_DATASTORE_VIEWSTATE : 0, indicates extended result codes for viewstate store.
} ADUC_FACILITY_DATASTORE_Components;
...
/**
 * @brief Extended Result Codes for ADUC_FACILITY_DATASTORE Facility
*/
static inline ADUC_Result_t MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_DATASTORE(const int32_t component, const int32_t value)
{
    return MAKE_ADUC_EXTENDEDRESULTCODE(ADUC_FACILITY_DATASTORE, component, value);
}

/**
* @brief Function for generating Extended Result Codes for ADUC_COMPONENT_DATASTORE_VIEWSTATE Component
*/
static inline ADUC_Result_t MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_DATASTORE_VIEWSTATE(const int32_t value)
{
    return MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_DATASTORE(ADUC_COMPONENT_DATASTORE_VIEWSTATE, value);
}
...
/**
 * @brief ADUC_ERC_DATASTORE_VIEWSTATE_INTERNAL_ERROR, ERC Value: 2952790017 (0xb0000001)
 */
 #define ADUC_ERC_DATASTORE_VIEWSTATE_INTERNAL_ERROR MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_DATASTORE_VIEWSTATE(1)

/**
 * @brief ADUC_ERC_DATASTORE_VIEWSTATE_INVALID_SCHEMA_VERSION, ERC Value: 2952790018 (0xb0000002)
 */
 #define ADUC_ERC_DATASTORE_VIEWSTATE_INVALID_SCHEMA_VERSION MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_DATASTORE_VIEWSTATE(2)

/**
 * @brief ADUC_ERC_DATASTORE_VIEWSTATE_STORE_NOT_FOUND, ERC Value: 2952790019 (0xb0000003)
 */
 #define ADUC_ERC_DATASTORE_VIEWSTATE_STORE_NOT_FOUND MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_DATASTORE_VIEWSTATE(3)
