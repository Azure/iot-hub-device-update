...
/**
 * @brief ADUC_ERC_ROOTKEY_PACKAGE_INSTALL, ERC Value: 2684354568 (0xa0000008)
 */
 #define ADUC_ERC_ROOTKEY_PACKAGE_INSTALL MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_ROOTKEY_WORKFLOW(8)
