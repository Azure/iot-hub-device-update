...
/**
 * @brief ADUC_ERC_UTILITIES_URL_CREATE, ERC Value: 2154823681 (0x80700001)
 */
 #define ADUC_ERC_UTILITIES_URL_CREATE MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_URL_UTIL(1)

/**
 * @brief ADUC_ERC_UTILITIES_URL_SET, ERC Value: 2154823682 (0x80700002)
 */
 #define ADUC_ERC_UTILITIES_URL_SET MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_URL_UTIL(2)

/**
 * @brief ADUC_ERC_UTILITIES_URL_GET_PATH, ERC Value: 2154823683 (0x80700003)
 */
 #define ADUC_ERC_UTILITIES_URL_GET_PATH MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_URL_UTIL(3)

/**
 * @brief ADUC_ERC_UTILITIES_URL_BAD_PATH, ERC Value: 2154823684 (0x80700004)
 */
 #define ADUC_ERC_UTILITIES_URL_BAD_PATH MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_URL_UTIL(4)
