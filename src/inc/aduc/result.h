...
/**
 * @brief ADUC_ERC_UPPERLEVEL_WORKFLOW_NULL_PARAM, ERC Value: 536870916 (0x20000004)
 */
 #define ADUC_ERC_UPPERLEVEL_WORKFLOW_NULL_PARAM MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_UPPERLAYER_COMMON(4)
