...
/**
 * @brief ADUC_ERC_DATASTORE_VIEWSTATE_UNINITIALIZED, ERC Value: 2952790018 (0xb0000002)
 */
 #define ADUC_ERC_DATASTORE_VIEWSTATE_UNINITIALIZED MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_DATASTORE_VIEWSTATE(2)
