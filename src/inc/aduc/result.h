 ...
 */
 #define ADUC_ERC_UTILITIES_ROOTKEYPKG_PARSE_MISSING_REQUIRED_PROPERTY MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_ROOTKEYPKG_UTIL(4)

/**
 * @brief ADUC_ERC_UTILITIES_ROOTKEYPKG_PARSE_UNSUPPORTED_HASH_ALGORITHM, ERC Value: 2152726533 (0x80500005)
 */
 #define ADUC_ERC_UTILITIES_ROOTKEYPKG_PARSE_UNSUPPORTED_HASH_ALGORITHM MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_ROOTKEYPKG_UTIL(5)

/**
 * @brief ADUC_ERC_UTILITIES_ROOTKEYPKG_PARSE_INVALID_ENCODING, ERC Value: 2152726534 (0x80500006)
 */
 #define ADUC_ERC_UTILITIES_ROOTKEYPKG_PARSE_INVALID_ENCODING MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_ROOTKEYPKG_UTIL(6)

/**
 * @brief ADUC_ERC_UTILITIES_ROOTKEYPKG_PARSE_INVALID_KEY_ID, ERC Value: 2152726535 (0x80500007)
 */
 #define ADUC_ERC_UTILITIES_ROOTKEYPKG_PARSE_INVALID_KEY_ID MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_ROOTKEYPKG_UTIL(7)

/**
 * @brief ADUC_ERC_UTILITIES_ROOTKEYPKG_PARSE_UNSUPPORTED_KEYTYPE, ERC Value: 2152726536 (0x80500008)
 */
 #define ADUC_ERC_UTILITIES_ROOTKEYPKG_PARSE_UNSUPPORTED_KEYTYPE MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_ROOTKEYPKG_UTIL(8)

/**
 * @brief ADUC_ERC_UTILITIES_ROOTKEYPKG_PARSE_INVALID_RSA_PARAMETERS, ERC Value: 2152726537 (0x80500009)
 */
 #define ADUC_ERC_UTILITIES_ROOTKEYPKG_PARSE_INVALID_RSA_PARAMETERS MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_ROOTKEYPKG_UTIL(9)
