...
typedef enum tagADUC_Facility
{
    ...
    ADUC_FACILITY_EXTENSION_UPDATE_CONTENT_HANDLER =
        3, //!< ADUC_FACILITY_EXTENSION_UPDATE_CONTENT_HANDLER : 3, indicates errors from an update content handler
...
typedef enum tagADUC_FACILITY_EXTENSION_UPDATE_CONTENT_HANDLER_Components
{
    ADUC_CONTENT_HANDLER_COMMON =
        0, //!< ADUC_CONTENT_HANDLER_COMMON : 0, General error codes that can come from any content handler
    ADUC_CONTENT_HANDLER_SWUPDATE =
        1, //!< ADUC_CONTENT_HANDLER_SWUPDATE : 1, Results that originate from the SwUpdate Content Handler
    ADUC_CONTENT_HANDLER_APT =
        2, //!< ADUC_CONTENT_HANDLER_APT : 2, Results that originate from the APT Content Handler
    ...
    ADUC_CONTENT_HANDLER_STEPS =
        4, //!< ADUC_CONTENT_HANDLER_STEPS : 4, Results that originate from the steps handler part of the content handlers
    ADUC_CONTENT_HANDLER_SCRIPT =
        5, //!< ADUC_CONTENT_HANDLER_SCRIPT : 5, Results that originate from the script handler part of the content handlers
    ADUC_CONTENT_HANDLER_EXTERNAL =
        32, //!< ADUC_CONTENT_HANDLER_EXTERNAL : 32, indicates errors from Custom Update handlers, only included here for completeness
...
*/
static inline ADUC_Result_t
MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_UNKNOWN(const unsigned int component, const int32_t value)
{
...
*/
static inline ADUC_Result_t
MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_LOWERLAYER(const unsigned int component, const int32_t value)
{
...
*/
static inline ADUC_Result_t
MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_UPPERLAYER(const unsigned int component, const int32_t value)
{
...
static inline ADUC_Result_t MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_EXTENSION_UPDATE_CONTENT_HANDLER(
    const unsigned int component, const int32_t value)
{
...
*/
static inline ADUC_Result_t
MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_UTILITY(const unsigned int component, const int32_t value)
{
...
*/
static inline ADUC_Result_t MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_DOWNLOAD_HANDLER(
    const unsigned int component, const int32_t value)
{
...
*/
static inline ADUC_Result_t
MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_UNUSED_A(const unsigned int component, const int32_t value)
{
...
*/
static inline ADUC_Result_t
MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_UNUSED_B(const unsigned int component, const int32_t value)
{
...
*/
static inline ADUC_Result_t
MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_UNUSED_C(const unsigned int component, const int32_t value)
{
...
*/
static inline ADUC_Result_t
MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_UNUSED_E(const unsigned int component, const int32_t value)
{
...
*/
static inline ADUC_Result_t
MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_UNUSED_F(const unsigned int component, const int32_t value)
{
...
#define ADUC_ERC_APT_HANDLER_PACKAGE_CANCEL_FAILURE \
    MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_CONTENT_HANDLER_APT(768)
