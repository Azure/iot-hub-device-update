...
/**
 * @brief ADUC_ERC_UTILITIES_ROOTKEYPKG_UTIL_ERROR_BAD_JSON, ERC Value: 2152726529 (0x80500001)
 */
 #define ADUC_ERC_UTILITIES_ROOTKEYPKG_UTIL_ERROR_BAD_JSON MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_ROOTKEYPKG_UTIL(1)

/**
 * @brief ADUC_ERC_UTILITIES_ROOTKEYPKG_UTIL_ERROR_PARSE, ERC Value: 2152726530 (0x80500002)
 */
 #define ADUC_ERC_UTILITIES_ROOTKEYPKG_UTIL_ERROR_PARSE MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_ROOTKEYPKG_UTIL(2)
