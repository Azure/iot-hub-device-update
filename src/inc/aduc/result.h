...
typedef enum tagADUC_FACILITY_UNKNOWN_Components
{
    ...
    ADUC_COMPONENT_COMMON_ERRORS=2, //!< ADUC_COMPONENT_COMMON_ERRORS : 2, Errors that are common across the codebase but are not ERRNO errors
...
*/
static inline ADUC_Result_t MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_INFRA_MGMT(const unsigned int component, const int32_t value)
{
...
/**
 * @brief ADUC_ERC_INVALIDARG, ERC Value: 2097153 (0x200001)
 */
...
/**
 * @brief ADUC_ERC_UTILITIES_ROOTKEYUTIL_ROOTKEY_KID_FOUND_BUT_DISABLED, ERC Value: 2153775128 (0x80600018)
 */
 #define ADUC_ERC_UTILITIES_ROOTKEYUTIL_ROOTKEY_KID_FOUND_BUT_DISABLED MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_ROOTKEY_UTIL(24)

/**
 * @brief ADUC_ERC_UTILITIES_ROOTKEYUTIL_FAILED_TO_CREATE_CONTEXT, ERC Value: 2153775129 (0x80600019)
 */
 #define ADUC_ERC_UTILITIES_ROOTKEYUTIL_FAILED_TO_CREATE_CONTEXT MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_ROOTKEY_UTIL(25)

/**
 * @brief ADUC_ERC_UTILITIES_ROOTKEYUTIL_STORE_HANDLE_MISSING_IN_CONTEXT, ERC Value: 2153775130 (0x8060001a)
 */
 #define ADUC_ERC_UTILITIES_ROOTKEYUTIL_STORE_HANDLE_MISSING_IN_CONTEXT MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_ROOTKEY_UTIL(26)

/**
 * @brief ADUC_ERC_UTILITIES_ROOTKEYUTIL_STORE_TEMPFILENAME, ERC Value: 2153775131 (0x8060001b)
 */
 #define ADUC_ERC_UTILITIES_ROOTKEYUTIL_STORE_TEMPFILENAME MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_ROOTKEY_UTIL(27)
