...
typedef enum tagADUC_Facility
{
    ...
    ADUC_FACILITY_DOWNLOAD_HANDLER = 0x9,
...
// Download handler Components
typedef enum tagADUC_DownloadHandlerComponent
{
    // 0x00 - 0x1F are reserved for DU-provided download handlers
    // 0x00 - 0x07 are reserved for download handler
    ADUC_COMPONENT_DOWNLOAD_HANDLER_EXTENSION_MANAGER = 0x00,
    ADUC_COMPONENT_DOWNLOAD_HANDLER_PLUGIN = 0x01,
    // 0x08 - 0x0F are reserved for Delta download handler
    ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_COMMON = 0x08,
    ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_SOURCE_UPDATE_CACHE = 0x09,
    ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_DELTA_PROCESSOR = 0x0A,

    // 0x20-0xFF are available to customers and partner download handlers
} ADUC_DownloadHandlerComponent;

/**
 * @brief Macros to convert a Download Handler Extension component and error result code to an extended result code.
 * The facility code for these errors is ADUC_FACILITY_DOWNLOAD_HANDLER.
 *
 * Error code starts at: 0x9#######
 *
 * @param component The download handler component.
 * @param value An error value. Only the lowest 20-bits is used.
 */
static inline ADUC_Result_t
MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_DownloadHandlerComponent component, const int value)
{
...
#define MAKE_DELTA_PROCESSOR_EXTENDEDRESULTCODE(errorCode) \
    MAKE_ADUC_EXTENDEDRESULTCODE(                          \
        ADUC_FACILITY_DOWNLOAD_HANDLER, ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_DELTA_PROCESSOR, errorCode)

//
// DownloadHandler Extension Manager Extended Error Codes
//
#define ADUC_ERC_DOWNLOAD_HANDLER_EXTENSION_MANAGER_CREATE_FAILURE_CREATE \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DOWNLOAD_HANDLER_EXTENSION_MANAGER, 0x00001)

//
// DownloadHandler Plugin Error Codes
//
#define ADUC_ERC_DOWNLOAD_HANDLER_PLUGIN_ON_UPDATE_WORKFLOW_COMPLETED_FAILURE \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DOWNLOAD_HANDLER_PLUGIN, 0x00001)

//
// DeltaDownloadHandler Common Extended Error Codes
//
#define ADUC_ERC_DDH_BAD_ARGS \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_COMMON, 0x00001)

#define ADUC_ERC_DDH_RELATEDFILE_NO_PROPERTIES \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_COMMON, 0x00002)

#define ADUC_ERC_DDH_RELATEDFILE_BAD_OR_MISSING_HASH_PROPERTIES \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_COMMON, 0x00003)

#define ADUC_ERC_DDH_MAKE_DELTA_UPDATE_PATH \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_COMMON, 0x00004)

#define ADUC_ERC_DDH_PROCESSOR_LOAD_LIB \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_COMMON, 0x00005)

#define ADUC_ERC_DDH_PROCESSOR_ENSURE_SYMBOLS \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_COMMON, 0x00006)

#define ADUC_ERC_DDH_PROCESSOR_CREATE_SESSION \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_COMMON, 0x00007)

#define ADUC_ERC_DDH_SOURCE_UPDATE_CACHE_MISS \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_COMMON, 0x00008)

// DeltaDownloadHandler SourceUpdateCache Extended Error Codes

#define ADUC_ERC_MOVE_PREPURGE \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_SOURCE_UPDATE_CACHE, 0x00001)

#define ADUC_ERC_MOVE_PAYLOAD \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_SOURCE_UPDATE_CACHE, 0x00002)

#define ADUC_ERC_MOVE_POSTPURGE \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_SOURCE_UPDATE_CACHE, 0x00003)

#define ADUC_ERC_MOVE_CREATE_CACHE_PATH \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_SOURCE_UPDATE_CACHE, 0x00004)

#define ADUC_ERC_MOVE_COPYFALLBACK \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_SOURCE_UPDATE_CACHE, 0x00005)

#define ADUC_ERC_LOOKUP_CREATE_PATH \
    MAKE_ADUC_DOWNLOAD_HANDLER_EXTENDEDRESULTCODE(ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_SOURCE_UPDATE_CACHE, 0x00006)
