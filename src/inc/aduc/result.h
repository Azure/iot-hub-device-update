...
{
    ADUC_COMPONENT_VIEWSTATE = 0, //!< ADUC_COMPONENT_VIEWSTATE : 0, indicates extended result codes for viewstate management.
...
*/
static inline ADUC_Result_t MAKE_ADUC_EXTENDEDRESULTCODE_FOR_FACILITY_ADUC_FACILITY_API(const int32_t component, const int32_t value)
{
 ...
 */
 #define ADUC_ERC_MOVE_HASH_VERIFICATION_FAILED MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_COMPONENT_DELTA_DOWNLOAD_HANDLER_SOURCE_UPDATE_CACHE(8)
