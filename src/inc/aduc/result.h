...
/**
 * @brief ADUC_ERC_CONTENT_DOWNLOADER_GETCOMPONENTSVERSIONPROC_NOTIMP, ERC Value: 1073741838 (0x4000000e)
 */
 #define ADUC_ERC_CONTENT_DOWNLOADER_GETCOMPONENTSVERSIONPROC_NOTIMP MAKE_ADUC_EXTENDEDRESULTCODE_FOR_COMPONENT_ADUC_CONTENT_DOWNLOADER_COMMON(14)
