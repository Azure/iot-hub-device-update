...
#define ADUC_ERC_EXTENSION_FAILURE_REQUIED_FUNCITON_NOTIMPL(facility, component) \
...
#define ADUC_ERC_SWUPDATE_HANDLER_INSTALL_FAILURE_BAD_FILE_ENTITY MAKE_ADUC_SWUPDATE_HANDLER_EXTENDEDRESULTCODE(0x202)
...
//
// Bundle Update Handler errors.
//

/**
 * @brief Macros to convert Bundle Handler results to extended result code values.
...
// General errors.
#define ADUC_ERC_BUNDLE_HANDLER_CREATE_LEAF_WORKFLOW_BAD_MANIFEST MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(1)

#define ADUC_ERC_BUNDLE_HANDLER_CREATE_LEAF_WORKFLOW_BAD_BASE_MANIFEST MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(2)

#define ADUC_ERC_BUNDLE_HANDLER_CREATE_LEAF_WORKFLOW_BAD_FILEURLS MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(3)

#define ADUC_ERC_BUNDLE_HANDLER_CREATE_LEAF_WORKFLOW_CANT_ADD_TO_PARENT MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(4)

#define ADUC_ERC_BUNDLE_HANDLER_INSTALLCRITERIA_PERSIST_FAILURE MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(5)

#define ADUC_ERC_BUNDLE_CONTENT_HANDLER_CREATE_FAILURE_FILEURLS_CLONE_FAILURE \
    MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(14)

#define ADUC_ERC_BUNDLE_CONTENT_HANDLER_CREATE_FAILURE_SET_FILEURLS_FAILURE \
    MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(15)

#define ADUC_ERC_BUNDLE_CONTENT_HANDLER_COMPONENT_ENUMERATION_FAILURE MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(16)

#define ADUC_ERC_BUNDLE_CONTENT_HANDLER_SET_SELECTED_COMPONENTS_FAILURE MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(17)

#define ADUC_ERC_BUNDLE_CONTENT_HANDLER_GET_FILE_ENTITY_FAILURE MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(18)

#define ADUC_ERC_BUNDLE_CONTENT_HANDLER_GET_LEAF_COMPAT_FAILURE MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(19)

// Download related errors (0x100 - 0x1FF)
#define ADUC_ERC_BUNDLE_CONTENT_HANDLER_DOWNLOAD_FAILURE_UNKNOWNEXCEPTION \
    MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(0x100)

// Install related errors (0x200 - 0x2FF)
#define ADUC_ERC_BUNDLE_CONTENT_HANDLER_INSTALL_FAILURE_UNKNOWNEXCEPTION \
    MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(0x200)

#define ADUC_ERC_BUNDLE_CONTENT_HANDLER_INSTALL_FAILURE_MISSING_CHILD_WORKFLOW \
    MAKE_ADUC_BUNDLE_HANDLER_EXTENDEDRESULTCODE(0x201)
...
/**
 * @brief Macros to convert Components Handler results to extended result code values.
...
//
// Components Update Handler errors.
// (Begins with 0x305#####)
//

// General errors. (0x30500000 - 0FF)
#define ADUC_ERC_COMPONENTS_HANDLER_ERROR_NONE MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(0)

#define ADUC_ERC_COMPONENTS_HANDLER_INITIALIZATION_FAILURE MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(1)

#define ADUC_ERC_COMPONENTS_HANDLER_INVALID_COMPONENTS_DATA MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(2)

#define ADUC_ERC_COMPONENTS_HANDLER_GET_FILE_ENTITY_FAILURE MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(3)

#define ADUC_ERC_COMPONENTS_HANDLER_CREATE_SANDBOX_FAILURE MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(4)

#define ADUC_ERC_COMPONENTS_HANDLER_SET_SELECTED_COMPONENTS_FAILURE MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(5)

// Download related errors. (0x30500100 - 1FF)
#define ADUC_ERC_COMPONENTS_HANDLER_DOWNLOAD_FAILURE MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(0x100)

#define ADUC_ERC_COMPONENTS_HANDLER_DOWNLOAD_FAILURE_UNKNOWN_EXCEPTION \
    MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(0x101)

// Install related errors. (0x30500200 - 2FF)
#define ADUC_ERC_COMPONENTS_HANDLER_INSTALL_FAILURE_NO_INSTRUCTION_FILE \
    MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(0x201)

#define ADUC_ERC_COMPONENTS_HANDLER_INSTALL_FAILURE_INSTRUCTION_PARSE_FAILURE \
    MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(0x202)

#define ADUC_ERC_COMPONENTS_HANDLER_INSTALL_FAILURE_INSTALLITEM_BAD_DATA \
    MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(0x203)

#define ADUC_ERC_COMPONENTS_HANDLER_INSTALL_FAILURE_NO_UPDATE_TYPE \
    MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(0x204)

#define ADUC_ERC_COMPONENTS_HANDLER_INSTALL_INSTALLITEM_INSTALL_UNKNOWN_EXCEPTION \
    MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(0x210)

#define ADUC_ERC_COMPONENTS_HANDLER_INSTALL_INSTALLITEM_ISINSTALLED_UNKNOWN_EXCEPTION \
    MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(0x211)

// Apply related errors. (0x30500301 - 3FF)

#define ADUC_ERC_COMPONENTS_HANDLER_APPLY_INSTALLITEM_INSTALL_UNKNOWN_EXCEPTION \
    MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(0x310)

#define ADUC_ERC_COMPONENTS_HANDLER_APPLY_INSTALLITEM_ISINSTALLED_UNKNOWN_EXCEPTION \
    MAKE_ADUC_COMPONENTS_HANDLER_EXTENDEDRESULTCODE(0x311)
...
// Download errors. (0x30600100 - 1FF)
#define ADUC_ERC_SCRIPT_HANDLER_DWONLOAD_ERROR_NULL_WORKFLOW MAKE_ADUC_SCRIPT_HANDLER_EXTENDEDRESULTCODE(0x101)
...
#define ADUC_ERC_UTILITIES_WORKFLOW_UTIL_COPY_UPDATE_ACITON_FROM_BASE_FAILURE \
...
#define ADUC_ERC_UTILITIES_WORKFLOW_UTIL_COPY_UPDATE_ACTION_SET_UPDATE_TYPE_FAILURE \
    MAKE_ADUC_UTILITIES_EXTENDEDRESULTCODE(ADUC_COMPONENT_WORKFLOW_UTIL, 10)
...
#define ADUC_ERC_UPDATE_CONTENT_HANDLER_PREPARE_FAILURE_ALREADY_INITIALZIED \
    MAKE_ADUC_COMMON_HANDLER_EXTENDEDRESULTCODE(102)

#define ADUC_ERC_UPDATE_CONTENT_HANDLER_PREPARE_FAILURE_WRONG_FILECOUNT \
    MAKE_ADUC_COMMON_HANDLER_EXTENDEDRESULTCODE(103)
