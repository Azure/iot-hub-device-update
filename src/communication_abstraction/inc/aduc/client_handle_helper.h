 ...
 */
MOCKABLE_FUNCTION(,_Bool, ClientHandle_CreateFromConnectionString, ADUC_ClientHandle*, iotHubClientHandle,ADUC_ConnType, type ,const char*, connectionString, IOTHUB_CLIENT_TRANSPORT_PROVIDER, protocol)
 ...
 */
MOCKABLE_FUNCTION(,IOTHUB_CLIENT_RESULT, ClientHandle_SetConnectionStatusCallback, ADUC_ClientHandle, iotHubClientHandle, IOTHUB_CLIENT_CONNECTION_STATUS_CALLBACK, connectionStatusCallback, void*, userContextCallback)
 ...
 * 
 */
MOCKABLE_FUNCTION(,IOTHUB_CLIENT_RESULT, ClientHandle_SendEventAsync, ADUC_ClientHandle, iotHubClientHandle, IOTHUB_MESSAGE_HANDLE, eventMessageHandle, IOTHUB_CLIENT_EVENT_CONFIRMATION_CALLBACK, eventConfirmationCallback, void*, userContextCallback);
 ...
 * @details Uses either the device or module function depending on what the client type has been set to.
 */
MOCKABLE_FUNCTION(,IOTHUB_CLIENT_RESULT, ClientHandle_SetOption,ADUC_ClientHandle, iotHubClientHandle, const char*, optionName, const void*, value);

/**
 * @brief Wrapper for the DEvice and Module SetClientTwinCallback functions
 * @details Uses either the device or module function depending on what the client type has been set to.
 */
MOCKABLE_FUNCTION(,IOTHUB_CLIENT_RESULT, ClientHandle_SetClientTwinCallback,ADUC_ClientHandle ,iotHubClientHandle, IOTHUB_CLIENT_DEVICE_TWIN_CALLBACK, moduleTwinCallback, void*, userContextCallback)
 ...
 * 
 */
MOCKABLE_FUNCTION(,IOTHUB_CLIENT_RESULT, ClientHandle_SendReportedState,ADUC_ClientHandle, iotHubClientHandle, const unsigned char*, reportedState, size_t, size, IOTHUB_CLIENT_REPORTED_STATE_CALLBACK, reportedStateCallback, void*, userContextCallback)
 ...
 * 
 */
MOCKABLE_FUNCTION(,IOTHUB_CLIENT_RESULT, ClientHandle_SetDeviceMethodCallback,ADUC_ClientHandle, iotHubClientHandle, IOTHUB_CLIENT_DEVICE_METHOD_CALLBACK_ASYNC, moduleMethodCallback, void* ,userContextCallback)
